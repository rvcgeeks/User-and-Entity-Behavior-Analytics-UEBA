...
python3 6-Mix_Users_Data_and_Label.py

python3 7.1-Unsupervised_Isolation_Forest_Training_and_Metrics.py
python3 7.2-Supervised_MLP_Training_and_Metrics.py
